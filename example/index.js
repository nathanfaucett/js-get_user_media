(function(dependencies, chunks, undefined, global) {
    ...
    global["uLG8kWPM-FU3E-4pdI-kpNn-qaFIuM9cxJhPU"] = function(asyncDependencies) {
        var i = -1,
...
/*@=-/var/www/html/node/_stream/js-media_devices/example/src/index.js-=@*/
var isUndefined = require(1),
    arrayForEach = require(2),
    eventListener = require(3),
    mediaDevices = require(4);
...
function(require, exports, module, undefined, global) {
/*@=-@nathanfaucett/media_devices@0.0.1/src/index.js-=@*/
var environment = require(9);
...
mediaDevices.getDevices = require(20);
mediaDevices.getMedia = require(21);
},
function(require, exports, module, undefined, global) {
/*@=-webrtc-adapter@4.1.0/src/js/adapter_core.js-=@*/
/*
...
function(require, exports, module, undefined, global) {
/*@=-@nathanfaucett/media_devices@0.0.1/src/getDevices.js-=@*/
var environment = require(9),
    isFunction = require(8);
...
function(require, exports, module, undefined, global) {
/*@=-@nathanfaucett/media_devices@0.0.1/src/getMedia.js-=@*/
var environment = require(9),
    isFunction = require(8);
...
function(require, exports, module, undefined, global) {
/*@=-webrtc-adapter@4.1.0/src/js/adapter_factory.js-=@*/
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
module.exports = function(dependencies, opts) {
  ...
  // will not appear.
  // require(23).disableLog(false);

  // Browser shims.
  var chromeShim = require(24) || null;
  var edgeShim = require(25) || null;
  var firefoxShim = require(26) || null;
  var safariShim = require(27) || null;
...
function(require, exports, module, undefined, global) {
/*@=-webrtc-adapter@4.1.0/src/js/utils.js-=@*/
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
function(require, exports, module, undefined, global) {
/*@=-webrtc-adapter@4.1.0/src/js/chrome/chrome_shim.js-=@*/
...
module.exports = {
  ...
  shimGetUserMedia: require(28)
};

},
function(require, exports, module, undefined, global) {
/*@=-webrtc-adapter@4.1.0/src/js/edge/edge_shim.js-=@*/
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
var utils = require(23);
var shimRTCPeerConnection = require(29);

module.exports = {
  shimGetUserMedia: require(30),
  shimPeerConnection: function(window) {
    var browserDetails = utils.detectBrowser(window);
...
function(require, exports, module, undefined, global) {
/*@=-webrtc-adapter@4.1.0/src/js/firefox/firefox_shim.js-=@*/
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
module.exports = {
  ...
  shimGetUserMedia: require(32)
};

},
function(require, exports, module, undefined, global) {
/*@=-webrtc-adapter@4.1.0/src/js/safari/safari_shim.js-=@*/
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
function(require, exports, module, undefined, global) {
/*@=-webrtc-adapter@4.1.0/src/js/chrome/getusermedia.js-=@*/
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
function(require, exports, module, undefined, global) {
/*@=-webrtc-adapter@4.1.0/src/js/edge/rtcpeerconnection_shim.js-=@*/
/*
...
function(require, exports, module, undefined, global) {
/*@=-webrtc-adapter@4.1.0/src/js/edge/getusermedia.js-=@*/
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
...
function(require, exports, module, undefined, global) {
/*@=-webrtc-adapter@4.1.0/src/js/firefox/getusermedia.js-=@*/
/*
 *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
 *
 *  Use of this source code is governed by a BSD-style license
